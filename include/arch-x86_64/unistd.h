...
#define __NR_sys_vperfctr_init			531
__SYSCALL(__NR_sys_vperfctr_init, sys_vperfctr_init)

#define __NR_sys_vperfctr_control		532
__SYSCALL(__NR_sys_vperfctr_control, sys_vperfctr_control)

#define __NR_sys_vperfctr_read			533
__SYSCALL(__NR_sys_vperfctr_read, sys_vperfctr_read)

#define __NR_sys_vperfctr_write			534
__SYSCALL(__NR_sys_vperfctr_write, sys_vperfctr_write)
